...
public class StubGame2 implements Game {
  ...
  //Todo placeholders for Game, but need implemented stub behavior
  public void addUnitGameLevel(Position p, Player name, String unitType){}
  public void commitToTranscript(String s){}
  public ArrayList<String> getTranscript(){ return null; }
  public AttackStrategy getAttackStrategy() { return null; }
  ...
  public void performUnitActionAt( Position p ) {
    ...
    System.out.println("-- StubGame2 / performUnitAction called.");
    System.out.print("IMPLEMENTATION PENDING");
  }
...
class StubUnit implements  Unit {
  ...
  //Todo placeholders for Unit, but need implemented stub behavior
  ...
  public boolean getPassThroughTerrain(){ return false; }
